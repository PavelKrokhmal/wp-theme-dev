jQuery(document).ready( function($){
    ...
    function sunset_get_bs_thumbs( id ){
        ...
        const nextThumb = $(id).find(".item.active").find(".next-image-preview").data("image");
        const prevThumb = $(id).find(".item.active").find(".prev-image-preview").data("image");
